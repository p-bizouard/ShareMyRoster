...
const dataURI = `data:text/plain;base64,${btoa(TEXT_CONTENT)}`;
...
function zipDataURI(dataURI, callback) {
  zip.createWriter(
    ...
    zipWriter => {
      zipWriter.add(FILENAME, new zip.Data64URIReader(dataURI), () => {
...
logDataURI(dataURI);
zipDataURI(dataURI, zippedData64 => {
  logDataURI(zippedData64);
  unzipDataURI(zippedData64, unzippedDataURI => {
